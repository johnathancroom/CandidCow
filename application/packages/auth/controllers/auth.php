...
class Auth extends MY_Controller
{
	...
	function index()
	{
		if ($message = $this->session->flashdata('message')) {
			$this->_render('croomy_auth/general_message', array('message' => $message), TRUE, FALSE);
		} else {
			redirect('/auth/login/');
		}
	}
	...
	function login()
	{
		if ($this->croomy_auth->is_logged_in()) {									// logged in
			...
			$this->_render('croomy_auth/login_form', $data, TRUE, FALSE);
		}
	}
	...
	function register()
	{
		if ($this->croomy_auth->is_logged_in()) {									// logged in
			...
			$this->_render('croomy_auth/register_form', $data, TRUE, FALSE);
		}
	}
	...
	function send_again()
	{
		if (!$this->croomy_auth->is_logged_in(FALSE)) {							// not logged in or activated
			...
			$this->_render('croomy_auth/send_again_form', $data, TRUE, FALSE);
		}
	}
	...
	function forgot_password()
	{
		if ($this->croomy_auth->is_logged_in()) {									// logged in
			...
			$this->_render('croomy_auth/forgot_password_form', $data, TRUE, FALSE);
		}
	}
	...
	function reset_password()
	{
		...
		$this->_render('croomy_auth/reset_password_form', $data, TRUE, FALSE);
	}
	...
	function change_password()
	{
		if (!$this->croomy_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->_render('croomy_auth/change_password_form', $data, TRUE, FALSE);
		}
	}
	...
	function change_email()
	{
		if (!$this->croomy_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->_render('croomy_auth/change_email_form', $data, TRUE, FALSE);
		}
	}
	...
	function unregister()
	{
		if (!$this->croomy_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->_render('croomy_auth/unregister_form', $data, TRUE, FALSE);
		}
	}
